...
public class CourseController {
  ...
  public ResponseEntity<CourseResponseDTO> maakCourse(
      @RequestBody @Valid CourseDTO dto, @AuthenticationPrincipal UserPrincipal user) {
  ...
  public ResponseEntity<String> linkCourseAntwoord(
      @RequestBody @Valid courseantwoordDTO dto, @AuthenticationPrincipal UserPrincipal user) {
