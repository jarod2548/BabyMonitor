...
public class VraagService {
  ...
  public VraagAntwoord maakVraagAntwoord(Long vraagId, Long antwoordId, boolean correct) {
  ...
  public boolean controleerAntwoord(Long vraagId, Long antwoordId) {
    ...
    VraagAntwoord vraagAntwoord =
        vraagAntwoordRepository.findByVraag_IdAndAntwoord_Id(vraagId, antwoordId).orElseThrow();
